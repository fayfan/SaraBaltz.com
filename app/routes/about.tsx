  ...
  return (
    <div className="bg-white">
      ...
      <main className="isolate">
        ...
        {/* Logo cloud */}
        <div className="mx-auto mt-30 max-w-7xl sm:px-6 lg:px-8">
          <div className="relative isolate overflow-hidden bg-blue-200 px-6 py-24 text-center shadow-2xl sm:rounded-3xl sm:px-16">
            <h2 style={{ color: 'white' }} className="mx-auto max-w-2xl text-3xl font-bold tracking-tight sm:text-4xl">
              Technical Skills
            </h2>
            {/* <p style={{ color: "#EAF1FD" }} className="mx-auto mt-6 max-w-xl text-lg/8">
            ...
            <div className="justify-items-center mx-auto mt-15 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-12 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 sm:gap-y-14 lg:max-w-4xl lg:grid-cols-5">
              {/* Node.js */}
              <a href='https://nodejs.org'>
                <svg xmlns="http://www.w3.org/2000/svg" fill="white" x="0px" y="0px" width="50" height="50" viewBox="0 0 16 16">
              ...
              <a href="https://www.python.org">
                <svg xmlns="http://www.w3.org/2000/svg" fill="white" x="0px" y="0px" width="50" height="50" viewBox="0 0 24 24">
              ...
              <a href="https://html.spec.whatwg.org/multipage">
                <svg xmlns="http://www.w3.org/2000/svg" fill="white" x="0px" y="0px" width="50" height="50" viewBox="0 0 24 24">
                  <path d="M 21 2 L 3 2 L 5 20 L 12 22 L 19 20 Z M 16.824219 8.082031 L 9.167969 8.082031 L 9.351563 10.261719 L 16.640625 10.261719 L 16.09375 16.699219 L 12 18.003906 L 11.960938 17.988281 L 7.914063 16.699219 L 7.691406 14.074219 L 9.675781 14.074219 L 9.761719 15.09375 L 12.023438 15.59375 L 14.242188 15.09375 L 14.480469 12.339844 L 7.542969 12.339844 L 7.007813 6 L 17.003906 6 Z"></path>
                </svg>
              </a>
              {/* CSS */}
              ...
              <a href="https://tailwindcss.com">
                <svg xmlns="http://www.w3.org/2000/svg" fill="white" x="0px" y="0px" width="50" height="50" viewBox="0 0 48 48">
              ...
              <a href="https://sequelize.org">
                <svg xmlns="http://www.w3.org/2000/svg" fill="white" width="50px" height="50px" viewBox='-10 236 510 40'>
              ...
              /> */}
              <p className="text-white font-semibold col-span-2 -col-end-1 sm:col-span-2 sm:-col-end-1 lg:col-span-1 lg:-col-end-1 mx-auto mt-6 max-w-xl text-lg/8">
                ...and more!
              </p>
            </div>
            <div
        ...
        {/* Content section */}
        <div className="mt-34 overflow-hidden">
            ...
            <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:max-w-none lg:min-w-full lg:flex-none lg:gap-y-8">
              <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
                ...
                <ul className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
                  <li>
                    <p style={{ color: 'cornflowerblue' }} className="text-xl font-semibold">My dog, Arlo</p>
                    <p className="text-sm text-gray-400">A blanket-loving Italian Greyhound</p>
                  </li>
                  <li>
                    <p style={{ color: 'cornflowerblue' }} className="text-xl font-semibold">Video games</p>
                    <p className="text-sm text-gray-400">Gotta do my Arknights dailies</p>
                  </li>
                  <li>
                    <p style={{ color: 'cornflowerblue' }} className="text-xl font-semibold">Anime</p>
                    <p className="text-sm text-gray-400">I recommend <em>Shin Sekai Yori</em></p>
                  </li>
                  <li>
                    <p style={{ color: 'cornflowerblue' }} className="text-xl font-semibold">日本語の勉強</p>
                    <p className="text-sm text-gray-400">よろしくお願いいたします</p>
                  </li>
                  <li>
                    <p style={{ color: 'cornflowerblue' }} className="text-xl font-semibold">Traveling</p>
                    <p className="text-sm text-gray-400">Next trip: NYC</p>
                  </li>
                  <li>
                    <p style={{ color: 'cornflowerblue' }} className="text-xl font-semibold">Food</p>
                    <p className="text-sm text-gray-400">Especially Japanese & Filipino</p>
                  </li>
                </ul>
        ...
        <div className="mx-auto mt-32 max-w-7xl px-6 sm:mt-40 lg:px-8">
          ...
          {/* <div className="mx-auto mt-16 flex max-w-2xl flex-col gap-8 lg:mx-0 lg:mt-20 lg:max-w-none lg:flex-row lg:items-end">
            <div style={{ background: "#EAF1FD" }} className="flex flex-col-reverse justify-between gap-x-16 gap-y-8 rounded-2xl p-8 sm:w-3/4 sm:max-w-md sm:flex-row-reverse sm:items-end lg:w-72 lg:max-w-none lg:flex-none lg:flex-col lg:items-start">
            ...
            <div style={{ background: 'cornflowerblue' }} className="flex flex-col-reverse justify-between gap-x-16 gap-y-8 rounded-2xl p-8 sm:w-11/12 sm:max-w-xl sm:flex-row-reverse sm:items-end lg:w-full lg:max-w-none lg:flex-auto lg:flex-col lg:items-start lg:gap-y-28">
              <p className="flex-none text-3xl font-bold tracking-tight text-white">
                401,093
              </p>
              <div className="sm:w-80 sm:shrink lg:w-auto lg:flex-none">
                ...
                <p style={{ color: "#D7E4FA" }} className="mt-2 text-base/7">
                ...
                {jobOpenings.map(opening => (
                  <li key={opening.id} className="py-8">
                    <dl className="relative flex flex-wrap gap-x-3">
                      ...
                      <dd style={{ color: 'cornflowerblue' }} className="w-full flex-none text-lg font-semibold tracking-tight text-gray-900">
                        <a href={opening.href}>
                          {opening.role}
                          <span
                            aria-hidden="true"
                      ...
                      <dd style={{ color: '#83AAF1' }} className="mt-4 flex items-center gap-x-3 text-base/7">
                        <svg
                          viewBox="0 0 2 2"
                          aria-hidden="true"
